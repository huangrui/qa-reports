...
Release.create! :name => "1.2", :normalized => "1.2", :sort_order => 0
Release.create! :name => "1.1", :normalized => "1.1", :sort_order => 1
Release.create! :name => "1.0", :normalized => "1.0", :sort_order => 2
