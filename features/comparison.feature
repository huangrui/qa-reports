Feature: Consolidated reports
  ...
  Scenario: Comparing results between two branches with differences
    ...
    And I should see "SMOKE-SIM-Disable_PIN_query" within "#test_case_1 .testcase_name"
    And I should see values "Fail,Fail,Fail,Pass" in columns of "#test_case_1 td"

    And I should see "SMOKE-SIM-Get_IMSI" within "#test_case_3 .testcase_name"
    And I should see values "Pass,Pass,Pass,Fail" in columns of "#test_case_3 td"
